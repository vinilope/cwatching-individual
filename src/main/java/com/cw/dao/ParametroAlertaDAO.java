...
public class ParametroAlertaDAO {
    ...
    public void inserirParametroAlerta(Empresa e, ParametroAlerta t) {
        ...
        con.update(sql, e.getIdEmpresa(), t.getMaxCpu(), t.getMaxRam(), t.getMaxVolume(), t.getSensisbilidadeMouse(), t.getRegistroMouseSeg(), t.getRegistroMaquinaSeg());
    }

    public ParametroAlerta buscarParametroAlertaPorEmpresa(Empresa e) {
        String sql = "SELECT * FROM parametro_alerta WHERE id_parametro = '%s'".formatted(e.getIdEmpresa());
